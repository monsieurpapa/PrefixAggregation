...
'''
rib.txt is the name of your RIB file. The function will return a dictionary where the keys are the prefixes and the values are the next hop for 
the prefix (or "*" if the prefix has been aggregated).
'''